...
<a href="{{route('post.show', ['post' => $post])}}">
    <div class="flex flex-col items-center justify-between gap-4 bg-gray-100 rounded-lg p-6 lg:flex-row hover:scale-105 transition-all">
        <div class="lg:w-2/3">
        ...
        <div class="max-w-sm">
            <img src="{{asset($post->image)}}" alt="" class="w-[210px] h-[170px] object-cover rounded-lg">
        </div>
    </div>
</a>
